  ...
  render() {
       if (this.state.hasData){
            return(
                    <div className="App">
                      <AppNav/>
                      <header class="curved-header"></header>
                      


                <section className="text-center">
                
                    <h5 className="h1-responsive font-weight-bold text-center my-5">Buy/Sell your company's stock</h5>
                        ...
                        {this.state.columns.map((col, j) =>
                            <div className="col-lg-4 col-md-12 mb-lg-0 mb-0" key={j}>
                                { i*3+j < this.state.total &&                                    
                                    ...
                                    <h5 className="font-weight-bold mb-1">Name of the company: {this.state.title[i*3+j]}</h5>
                                    ...
                                    <p className="desc">{this.state.desc[i*3+j]}</p>
                                    <button className="boutona" onClick={e => (e.preventDefault(),this.buyArt(this.state.tokenIds[i*3+j], this.state.price[i*3+j]))}>Buy</button>
                                </div>
       ...
       else
       {
           return(
                <div className="App">
                    <AppNav/>
                    <section className="text-center">
                        <h5 className="h1-responsive font-weight-bold text-center my-5">Buy your stocks here!</h5>
                        <div className="container">
                        <div className="alert alert-primary" role="alert">
                            Sell your stocks on Blockchain 
                        </div>
                        </div>
                    </section>
                </div>
